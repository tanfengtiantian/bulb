 ...
 */
public interface IScShopPrinterCustomComponentService {
     ...
     * @return 受影响的行数
     */
    Integer saveMultiplePrinterCustomComponent (List<ScShopPrinterCustomComponent> shopPrinterCustomComponentList);
     ...
     * @return 组件列表
     */
    List<ScShopPrinterCustomComponent> listPrinterTemplateCustomComponentByTemplateId(Integer documentTemplateId);
}
