 ...
 */
@Mapper
public interface ScOperationPrinterTemplateDocumentMapper {
     ...
     * @return 受影响的行数
     */
    Integer insertShopPrinterTemplateDocument (ScOperationPrinterTemplateDocument scShopPrinterTemplateDocument);
     ...
     */
    ScOperationPrinterTemplateDocument selectShopPrinterTemplateDocumentByPrimaryId(Integer id);
     ...
     * @return {@link ScOperationPrinterTemplateDocument}
     */
    ScOperationPrinterTemplateDocument selectShopPrinterTemplateDocumentByName(String name);
     ...
     * @return list
     */
    List<ScOperationPrinterTemplateDocument> selectPrinterTemplateDocumentByShopIdAndDocumentType (@Param("shopId") Integer shopId, @Param("documentType") Integer documentType);
}
