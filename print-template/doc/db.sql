...
(314003, 14, 0, 0, '票据名称', '预结单', '{"fontSize": 1,"textAlign":"center"}', '#{shopLogo}', 'text', 3, 1, 100, 3, now(), now()),
-- moduleId = 15
...
(321003, 21, 0, 0, '票据名称', '消费清单', '{"fontSize": 1,"textAlign":"center"}', '#{shopLogo}', '#{ticketType}', 3, 1, 100, 3, now(), now()),
...
-- moduleId = 34
(334001, 34, 0, 0, '取餐号/桌台号', '桌台号:001', '{"fontSize": 1,"textAlign":"left"}', '#{numType}:#{tableNum}', 'text', 1, 1, 100, 1, now(), now()),
(334002, 34, 0, 0, '订单来源', '外送-商户收银终端', '{"fontSize": 1,"textAlign":"left"}', '#{orderSource}', 'text', 2, 1, 100, 2, now(), now()),
(334003, 34, 0, 0, '第三方流水号', '&lt;第三方&gt;流水号:001', '{"fontSize": 1,"textAlign":"left"}', '#{thirdClient}流水号:#{thirdSerialNum}', 'text', 3, 1, 100, 3, now(), now()),
(334004, 34, 0, 0, '流水号', '流水号:1', '{"fontSize": 1,"textAlign":"left"}', '流水号:#{serialNum}', 'text', 4, 1, 50, 4, now(), now()),
(334005, 34, 0, 0, '人数', '人数:2', '{"fontSize": 1,"textAlign":"right"}', '人数:#{peopleNum}', 'text', 4, 2, 50, 5, now(), now()),
(334006, 34, 0, 0, '送达时间', '送达时间:MM-DD HH:mm送达', '{"fontSize": 1,"textAlign":"center"}', '#{transitTime}', 'text', 5, 1, 100, 6, now(), now()),
(334007, 34, 0, 0, '出单序号', '出单序号:1', '{"fontSize": 1,"textAlign":"left"}', '出单序号:#{orderSerialNumber}', 'text', 6, 1, 50, 7, now(), now()),
(334008, 34, 0, 0, '出单页码', '页码:1/5', '{"fontSize": 1,"textAlign":"right"}', '页码:#{orderPageNumber}', 'text', 6, 2, 50, 8, now(), now()),
-- moduleId = 35
(335001, 35, 0, 0, '整单备注', '整单备注:不要太辣', '{"fontSize": 1,"textAlign":"left"}', '整单备注:#{orderMemo}', 'text', 1, 1, 100, 1, now(), now()),
(335002, 35, 0, 0, '整单操作理由', '退货理由:上菜太慢,要求退菜', '{"fontSize": 1,"textAlign":"left"}', '#{orderOperationReason}', 'text', 2, 1, 100, 2, now(), now()),
(335003, 35, 0, 0, '商品表格', '', '', '', 'grid', 3, 1, 100, 3, now(), now()),
(335004, 35, 335003, 0, '中类名称', '中类(价格)', '{"fontSize": 1,"textAlign":"center"}', '#{goodMiddleCategoryName}', 'category', 4, 1, 100, 4, now(), now()),
(335005, 35, 335003, 0, '商品', '商品', '{"fontSize": 1,"textAlign":"left"}', '商品', 'head', 5, 1, 40, 5, now(), now()),
(335006, 35, 335003, 0, '单价', '单价', '{"fontSize": 1,"textAlign":"right"}', '单价', 'head', 5, 2, 20, 6, now(), now()),
(335007, 35, 335003, 0, '数量', '数量', '{"fontSize": 1,"textAlign":"right"}', '数量', 'head', 5, 3, 20, 7, now(), now()),
(335008, 35, 335003, 0, '价格', '价格', '{"fontSize": 1,"textAlign":"right"}', '价格', 'head', 5, 4, 20, 8, now(), now()),
(335009, 35, 335003, 0, '商品', '1.回锅肉', '{"fontSize": 1,"textAlign":"left"}', '#{good}', 'text', 6, 1, 40, 9, now(), now()),
(335010, 35, 335003, 0, '单价', '16.00', '{"fontSize": 1,"textAlign":"right"}', '#{price}', 'text', 6, 2, 20, 10, now(), now()),
(335011, 35, 335003, 0, '数量', '1/份', '{"fontSize": 1,"textAlign":"right"}', '#{number}', 'text', 6, 3, 20, 11, now(), now()),
(335012, 35, 335003, 0, '价格', '16.00', '{"fontSize": 1,"textAlign":"right"}', '#{amount}', 'text', 6, 4, 20, 12, now(), now()),
(335013, 35, 335003, 335015, '商品备注', '【备注:多放肉】', '{"fontSize": 1,"textAlign":"left"}', '#{memo}', 'text', 7, 1, 100, 13, now(), now()),
(335014, 35, 335003, 335016, '商品操作理由', '【作废理由:太甜了】', '{"fontSize": 1,"textAlign":"center"}', '#{dishOperationReason}', 'text', 8, 1, 100, 14, now(), now()),
(335015, 35, 0, 0, '单品备注', '控制商品里面的单品备注', '', '', 'hidden', 9, 1, 100, 15, now(), now()),
(335016, 35, 0, 0, '单品操作理由', '控制商品里面的单品操作理由', '', '', 'hidden', 10, 1, 100, 16, now(), now()),
